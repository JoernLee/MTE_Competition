 ...
 * Use the {@link NewRoomFragment#newInstance} factory method to
...
public class NewRoomFragment extends Fragment implements View.OnClickListener {
    ...
    public static NewRoomFragment newInstance(String param1) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        //保存文字
        tvSave = (TextView) view.findViewById(R.id.txt_save_image_room);
        ...
        //测试姿态
        tvImagePosX = (TextView)view.findViewById(R.id.tv_image_posture_x_room);
        tvImagePosY = (TextView)view.findViewById(R.id.tv_image_posture_y_room);
        tvImagePosZ = (TextView)view.findViewById(R.id.tv_image_posture_z_room);
        //目前距离
        tvNowDistance = (TextView)view.findViewById(R.id.tv_now_distance_room);
        //AM距离
        tvAmDistance = (TextView)view.findViewById(R.id.tv_am_distance_room);
        btnInAmDistance = (Button)view.findViewById(R.id.btn_in_amdistance_room);
        btnInAmDistance.setOnClickListener(this);
        //时间
        tvTime = (TextView)view.findViewById(R.id.tv_time_room);
        btnInTime = (Button)view.findViewById(R.id.btn_in_time_room);
        btnInTime.setOnClickListener(this);
        //地点
        tvLocation = (TextView)view.findViewById(R.id.tv_location_room);
        btnInLocation = (Button)view.findViewById(R.id.btn_location_room);
    ...
    public void onClick(View view) {
        switch (view.getId()){
            case R.id.txt_save_image_room:
                ...
                break;
            case R.id.btn_in_amdistance_room:
                tvAmDistance.setText(tvNowDistance.getText().toString());
                break;
            case R.id.btn_in_time_room:
                tvTime.setText(getTimeNow());
                break;
            case R.id.btn_location_room:
