 ...
 * Use the {@link NewMeasureFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class NewMeasureFragment extends Fragment implements View.OnClickListener {
    ...
    public static NewMeasureFragment newInstance(String param1) {
        NewMeasureFragment fragment = new NewMeasureFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        tvR = (TextView) view.findViewById(R.id.tv_right_distance_measure);
        //测试姿态
        tvImagePosX = (TextView)view.findViewById(R.id.tv_image_posture_x_measure);
        tvImagePosY = (TextView)view.findViewById(R.id.tv_image_posture_y_measure);
        tvImagePosZ = (TextView)view.findViewById(R.id.tv_image_posture_z_measure);
        //目前距离
        tvNowDistance = (TextView)view.findViewById(R.id.tv_now_distance_measure);
        //AM距离
        tvAmDistance = (TextView)view.findViewById(R.id.tv_am_distance_measure);
        btnInAmDistance = (Button)view.findViewById(R.id.btn_in_amdistance_measure);
        btnInAmDistance.setOnClickListener(this);

        //测算距离
        tvLength = (TextView)view.findViewById(R.id.tv_length_measure);
        tvWidth = (TextView)view.findViewById(R.id.tv_width_measure);
        tvHeight = (TextView)view.findViewById(R.id.tv_height_measure);
